...
sfig_path = 'figures/manuscript/supp_fig4/'
...
# Plot unsign props
#g = (sns.catplot(col='leiden', y='props', x='lesion_type', data=sc[~np.isin(sc['leiden'].values, leidens)], col_wrap=3, kind='box', sharey=False, height=2, palette=palette)
# .set_titles(template='State {col_name}').set_xlabels('').set_ylabels('Proportions').set_xticklabels(rotation=90)
#)
