...
# Important variables #
label_name="leiden"
path_to_regres="/net/data.isilon/ag-saez/bq_pbadia/VisiumMS/data/prc/visium/sclvm/"
...
for path_to_slide in ${path_to_slides}*; do
    sbatch --export=label_name=$label_name,path_to_regres=$path_to_regres,path_to_slide=$path_to_slide,path_to_output=$path_to_output \
