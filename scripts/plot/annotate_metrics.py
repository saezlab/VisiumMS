...
fig, ax = plt.subplots(1,2, figsize=(10,5), facecolor='white', tight_layout=True, dpi=150)
sc.pl.umap(adata, color='leiden', ax=ax[0], return_fig=False, show=False, add_outline=False, s=10)
