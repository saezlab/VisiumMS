...
factors_file <- "./submission/data/MOFAcell_factors.csv"
loadings_file <- "./submission/data/MOFAcell_loadings.csv"
mrkrs_file <- "./submission/data/edgeR_cellmrkrs.csv"
meta_file <- "./submission/data/MOFAcell_meta.csv"
mofamodel_file <- file.path("./submission/data/", "mofacell_complete.hdf5")
hmap_file <- "./submission/data/MOFAcell_hmap.pdf"
dist_file <- "./submission/data/MOFAcell_fspace.pdf"
bplots_file <- "./submission/data/MOFAcell_bplots.pdf"
qc_file <- "./submission/data/MOFAcell_datacompleteness.pdf"
